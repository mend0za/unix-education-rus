...
\begin{itemize}
\itemточка в начале файла указывает на то, что файл - скрытый, например \verb+.profile+
\itemфайл \verb+.+ - ссылка на текущий каталог (см. пример относительных путей)
\itemфайл \verb+..+ - ссылка на родительский каталог
\end{itemize}
